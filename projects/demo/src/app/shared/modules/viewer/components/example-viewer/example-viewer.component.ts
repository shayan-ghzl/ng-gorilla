...
export class ExampleViewerComponent implements OnInit {
  @ViewChildren(CodeSnippetComponent) readonly snippet!: QueryList<CodeSnippetComponent>;
  ...
  copySource(snippet: QueryList<CodeSnippetComponent>, selectedIndex: number = 0) {
